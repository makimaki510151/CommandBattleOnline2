...
export const characters = [
    ...
    },
    {
        ...
        status: {
            ...
            spd: 6,
            support: 33,
            criticalRate: 0.15, dodgeRate: 0.05, criticalMultiplier: 1.5
        },
        passive: {
            name: '執着',
            desc: '各アクティブが敵に当たらなかったとき、次回同じ敵を対象にしたとき対象の回避を半分減らした値で攻撃する',
            flavor: ''
        },
        active: [
            {
                name: '滅気',
                mp: 25,
                desc: '敵１体に「自身が誰かに攻撃を仕掛けるとき、攻撃した対象の回避を1.5倍した値で攻撃する」デバフを与える。ダメージ中。継続ターン 3',
                flavor: ''
            },
            {
                name: '衰躯',
                mp: 20,
                desc: '敵全体の防御力、魔法防御力、補助力を低下させるデバフを与える。ダメージ少。継続ターン 3',
                flavor: ''
            },
            {
                name: '呪縛',
                mp: 20,
                desc: '敵１体に「自身が誰かにダメージを与えたとき、自身に最大HPの5%分ダメージを受ける」「MP消費量1.5倍」のデバフを与える。ダメージ小。継続ターン 5',
                flavor: ''
            }
        ],
        special: {
            name: '虚空',
            mp: 60,
            desc: '敵全体に全基礎ステータス-25%のデバフを与える。ダメージ無。継続ターン 現在受けている状態異常、デバフ系の数×2（最低１ターン）',
            flavor: '',
            condition: null//相手にデバフが2個以上ついているとき。
        }
    }
];
