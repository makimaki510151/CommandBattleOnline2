...
export const characters = [
    ...
    // 3. 様々な支援を行うサポーター
    {
        ...
        passive: {
            name: '調和の旋律',
            desc: '自身の速度に応じて通常攻撃の威力が上昇する。',
            flavor: '（彼女の歌声は、戦う者の力を引き出す。）'
        },
        active: [
            sk('バトルソング', 25, 'all_allies', '（勇気と魔力を鼓舞する歌で、味方全体の攻撃力を高める。）'),
            sk('ミストステップ', 20, 'all_allies', '（風の精霊が、仲間の足取りを消し、回避力を高める。）'),
    ...
    // 4. 体力回復特化の回復職
    {
        ...
        passive: {
            name: '祈りの光',
            desc: '味方を回復すると、その回復量の10%を自身も回復する。',
            flavor: '（彼女の祈りは、奇跡を起こす。）'
        },
        active: [
            sk('ハイヒール', 20, 'ally_single_exclude_self', '（聖なる光が傷を瞬時に癒す。）'),
            sk('エリアヒール', 35, 'all_allies_exclude_self', '（広範囲に優しい癒やしの光を放つ。）'),
    ...
    // 5. MP回復特化の回復職
    {
        ...
        passive: {
            name: '魔力の泉',
            desc: 'MPを回復させた際の余剰分の50%が一時的追加MPになる（ターン終了時に消える）。',
            flavor: '（彼の魔力は尽きることがない。）'
        },
        active: [
            sk('マナチャージ', 10, 'ally_single_exclude_self', '（純粋な魔力を直接注入する。）'),
            sk('エナジーフロー', 40, 'all_allies_exclude_self', '（パーティ全体に魔力の流れを作り出す。）'),
    ...
    // 7. 単体特化のアタッカー
    {
        ...
        passive: {
            name: '孤高の刃',
            desc: '攻撃の非会心時は会心率が上昇。会心発生時、パッシブの上昇分を削除。繰り返し発動可。',
            flavor: '（狙った獲物は逃さない、孤高の剣。）'
        },
        active: [
            sk('ブレイクスルー', 30, 'single', '（敵の防御を貫く、渾身の一撃。）'),
            sk('ラピッドストライク', 15, 'single', '（瞬時のうちに三連撃を叩き込む。）'),
    ...
    // 8. 全体的にじわじわ削っていくアタッカー
    {
        ...
        status: {
            ...
            spd: 38,
            support: 14,
            criticalRate: 0.1, dodgeRate: 0.1, criticalMultiplier: 1.0
        },
        passive: {
            name: '炎の残滓',
            desc: '会心発生時、会心倍率が0.1倍上がる。戦闘終了まで累積する。',
            flavor: '（彼女の魔法が通った後には、燃え尽きた灰しか残らない。）'
        },
        active: [
            sk('ファイアストーム', 35, 'all_enemies', '（炎の嵐を呼び寄せ、全てを焼き払う。）'),
            sk('バーンバーン', 20, 'all_enemies', '（やけどの炎を爆発させ、敵に打撃を与える。）'),
            sk('バーニングアロー', 10, 'all_enemies', '（炎を纏った矢を放ち、敵の体を内側から燃やす。）')
        ],
        // 必殺技無効化（復活時はコメントを外す）
        // special: {
